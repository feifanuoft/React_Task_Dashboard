import {
  lib_default
} from "./chunk-PPKVINNN.js";
import {
  lib_exports
} from "./chunk-E4SKIDEW.js";
import {
  parse,
  print,
  visit
} from "./chunk-MFO5ERNF.js";
import "./chunk-AA3QR2AV.js";
import {
  require_pluralize
...
var T = (n) => ({ getList: async ({ resource: r, pagination: i, sorters: e, filters: t, meta: s }) => {
  ...
  if (s != null && s.gqlQuery)
    l = s == null ? void 0 : s.gqlQuery, p = { filter: t ? v(t) : {}, sorting: e ? R(e) : [], paging: o };
  else {
  ...
  if (e != null && e.gqlQuery)
    return { data: (await n.request(e.gqlQuery, { filter: { id: { in: i } } }))[t].nodes };
  ...
  if (s)
    return { data: (await n.request(s, { input: { [(0, import_camelcase.default)((0, import_pluralize.singular)(r))]: i } }))[t] };
  ...
  if (u)
    return { data: (await n.request(u, { input: { [(0, import_camelcase.default)(r)]: i } }))[s] };
  ...
  if (u)
    return { data: (await n.request(u, { input: { id: i, update: e } }))[s] };
  ...
  if (!s.some((p) => p === i))
    throw Error(`GraphQL does not support ${i} method.`);
  ...
  if (l)
    return { data: await a.request({ document: l, variables: t == null ? void 0 : t.variables }) };
  if (t != null && t.rawQuery)
    return { data: await a.request({ document: t.rawQuery, variables: t.variables }) };
  if (t) {
    if (t.operation) {
      let p, d;
      if (i === "get") {
