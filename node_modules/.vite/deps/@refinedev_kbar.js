...
import {
  ...
  se,
  xo
} from "./chunk-ZD4IE32Y.js";
import "./chunk-6J6H2MW5.js";
import {
  require_jsx_runtime
} from "./chunk-27DGUTZQ.js";
import "./chunk-PSV5CAQN.js";
...
var I = r(() => {
  let n = $(), { resource: e, resources: p, id: c, action: y } = Y(), l = se(), d = Dt(), b = Le(), { mutate: H } = xo(), { push: K, list: Pt2, create: wt, show: Tt, edit: kt } = Pe(), V = Pt(), $2 = (0, import_react3.useContext)(import_kbar3.KBarContext), { can: a } = HR(), [B, j] = (0, import_react3.useState)([]);
  (0, import_react3.useEffect)(() => {
    r(async () => await Promise.all(q().flatMap((i) => F(i))), "preaparedActions")().then((i) => j(i.flatMap((m) => m)));
  }, [p, c, e, y]), (0, import_react3.useEffect)(() => {
    B.length === 0 && $2.query.setVisualState(import_kbar3.VisualState.hidden);
  }, [B]);
  let q = r(() => {
